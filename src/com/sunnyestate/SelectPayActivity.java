...
public class SelectPayActivity extends BaseActivity {
		...
		public void handleMessage(Message msg) {
			...
			case SDK_PAY_FLAG: {
				...
				if (TextUtils.equals(resultStatus, "9000")) {
					Toast.makeText(SelectPayActivity.this, "支付成功",
					...
					if (TextUtils.equals(resultStatus, "8000")) {
						Toast.makeText(SelectPayActivity.this, "支付结果确认中",
								Toast.LENGTH_SHORT).show();

					} else {
						// 其他值就可以判断为支付失败，包括用户主动取消支付，或者系统返回的错误
						Toast.makeText(SelectPayActivity.this, "支付失败",
								Toast.LENGTH_SHORT).show();
			...
			case SDK_CHECK_FLAG: {
				Toast.makeText(SelectPayActivity.this, "检查结果为：" + msg.obj,
						Toast.LENGTH_SHORT).show();
				break;
			}
			default:
	...
	private void initView() {
		...
		txt_price.setText("￥" + pay_price + "0元");
		setListener();
	}
