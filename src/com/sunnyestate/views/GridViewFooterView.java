 ...
 * 
 */
public class GridViewFooterView extends LinearLayout {
	...
	public GridViewFooterView(Context context, AttributeSet attrs) {
		super(context, attrs);
		mContext = context;
		init();
	}

	public GridViewFooterView(Context context) {
		super(context);
		mContext = context;
		init();
	}
